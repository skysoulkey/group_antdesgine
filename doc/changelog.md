...
## 2026-04-13 — 系统日志需求文档输出

- 新建 `docs/superpowers/specs/系统日志需求文档.md`
- 登录日志：定义 4 种记录场景（登录/登出/登录失败/首次改密）及完整字段
- 操作日志：定义 9 种访问行为 + 27 种业务操作，共 36 种记录场景
- 每种操作定义详情 JSON 字段及完整示例
- 定义 7 个所属模块枚举、权限与数据隔离规则
